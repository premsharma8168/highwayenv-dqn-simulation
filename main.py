...
def make_env():
    ...
    def reward_function(env, action):
        ...
        # 1️ Base reward for staying alive
        reward += 1.0

        # 2️ Smooth and safe driving reward
        reward += 0.05 * (ego.speed / 30)

        # 3️ Maintain safe following distance
        if front_vehicle:
